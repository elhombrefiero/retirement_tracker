...
urlpatterns = [
    ...
    path('expense_overview/<int:pk>/', views.WithdrawalView.as_view(), name='withdrawal_overview'),
    # Ex. /finances/income_overview/pk
    path('income_overview/<int:pk>/', views.DepositView.as_view(), name='deposit_overview'),
